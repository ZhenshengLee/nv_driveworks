...
# customer
python3 ${DWCGF_PATH}/dwcgf/cli/transform.py ${DWCGF_PATH}/dwcgf/actions_customized/base_system/base_system.app.json -t ${DWCGF_PATH}/dwcgf/actions_customized/base_system/customized_actions.trans.json --actions=${DWCGF_PATH}/dwcgf/actions_customized/actions_customized.py -o ${CUSTOMER_OUTPUT_PATH}