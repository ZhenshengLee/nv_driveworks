...
class HyperepochDefinition:
    ...
    def __init__(
        ...
        *,
        ...
        monitoringPeriod: Optional[int] = None,
    ):
    ...
    @property
    def monitoringPeriod(self) -> int:
        """Return the monitoring threshold of this HyperepochDefinition."""
        if self._monitoringPeriod is None:
            return 0
        return self._monitoringPeriod

    @monitoringPeriod.setter
    def monitoringPeriod(self, new_monitoringPeriod: int) -> None:
        """Set the monitoring threshold of this HyperepochDefinition."""
        self._monitoringPeriod = new_monitoringPeriod
    ...
    def to_json_data(self) -> OrderedDict:
        ...
        if self.monitoringPeriod is not None and self.monitoringPeriod > 0:
            hyperepoch_json["monitoringPeriod"] = self.monitoringPeriod
    ...
    def from_json_data(cls, name: str, content: Dict) -> "ScheduleDefinition":
        ...
        hyperepochs = {
            name: HyperepochDefinition(
                ...
                monitoringPeriod=hyperepoch.get("monitoringPeriod", None),
                epochs={
