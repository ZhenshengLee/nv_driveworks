...
enum QNXMouseButtonCode : int32_t
{
    QNX_MOUSE_LEFT_BUTTON   = (1 << 0),
    QNX_MOUSE_MIDDLE_BUTTON = (1 << 1),
    QNX_MOUSE_RIGHT_BUTTON  = (1 << 2),
    QNX_MOUSE_WHEEL_UP      = (1 << 3),
    QNX_MOUSE_WHEEL_DOWN    = (1 << 4)
};
...
private:
    ...
    static int getGLFWMouseButtonCode(QNXMouseButtonCode btn);
    ...
    static std::map<QNXMouseButtonCode, int> screenMouseBtnToGLFW;
};
