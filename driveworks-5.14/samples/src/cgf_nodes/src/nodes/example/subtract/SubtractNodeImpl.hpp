...
class SubtractNodeImpl : public SimpleNodeT<SubtractNode>
{
public:
    static constexpr char LOG_TAG[] = "SubtractNode";
    using Base                      = SimpleNodeT<SubtractNode>;

    // Initialization and destruction
    SubtractNodeImpl(const SubtractNodeParams& params, const dwContextHandle_t ctx);
    ~SubtractNodeImpl() override;
