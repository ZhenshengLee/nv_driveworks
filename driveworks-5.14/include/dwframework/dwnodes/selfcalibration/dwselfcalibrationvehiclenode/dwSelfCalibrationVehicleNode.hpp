...
#ifndef DWFRAMEWORK_DWNODES_SELFCALIBRATION_DWSELFCALIBRATIONVEHICLENODE_DWSELFCALIBRATIONVEHICLENODE_HPP_
#define DWFRAMEWORK_DWNODES_SELFCALIBRATION_DWSELFCALIBRATIONVEHICLENODE_DWSELFCALIBRATIONVEHICLENODE_HPP_
 ...
 * @ingroup dwnodes
 */
class dwSelfCalibrationVehicleNode : public ExceptionSafeProcessNode
{
public:
    ...
    static constexpr char LOG_TAG[]{"dwSelfCalibrationVehicleNode"};
    ...
    static std::unique_ptr<dwSelfCalibrationVehicleNode> create(ParameterProvider& provider);
        ...
        return describeConstructorArguments<dwSelfCalibrationNodeParam, dwContextHandle_t>(
            describeConstructorArgument(
                ...
                DW_DESCRIBE_PARAMETER(
                    ...
                    &dwSelfCalibrationNodeParam::enableCalibration),
                DW_DESCRIBE_PARAMETER(
                    uint32_t,
                    "channelFifoSize"_sv,
    ...
    dwSelfCalibrationVehicleNode(const dwSelfCalibrationNodeParam& param, const dwContextHandle_t ctx);
};
} // namespace framework
} // namespace dw

#endif //DWFRAMEWORK_DWNODES_SELFCALIBRATION_DWSELFCALIBRATIONVEHICLENODE_DWSELFCALIBRATIONVEHICLENODE_HPP_
