...
#define SERIAL_STR_TYPE_MAP(t)     \
    {                              \
        #t, dwSerializationType::t \
    }

const dw::core::StaticHashMap<dw::core::FixedString<64>,
                              dwSerializationType,
                              static_cast<std::underlying_type_t<dwSerializationType>>(dwSerializationType::DW_TYPES_COUNT) - 1> // ignore DW_TYPE_INVALID and DW_TYPES_COUNT
    ...
    dwSerializationTypeStringToEnumMap{
        ...
        SERIAL_STR_TYPE_MAP(DW_TRAJECTORY_PLANNER_DEBUG_INFO),
        ...
        SERIAL_STR_TYPE_MAP(DW_EGOMOTION_POSE_PAYLOAD),
        ...
        SERIAL_STR_TYPE_MAP(DW_TENSOR_HANDLE),
        ...
        SERIAL_STR_TYPE_MAP(DW_LANE_CURVATURE_INFO),
        ...
        SERIAL_STR_TYPE_MAP(DW_LANE_GRAPH_TO_NAV_ROAD_GRAPH_MATCH),
        ...
        SERIAL_STR_TYPE_MAP(DW_DASHMARK_DETECTION),
        ...
        SERIAL_STR_TYPE_MAP(DW_LIDAR_POINT_CLOUD),
        ...
        SERIAL_STR_TYPE_MAP(DW_LOCALIZATION_INFO),
        ...
        SERIAL_STR_TYPE_MAP(DW_PARKING_PLANNER_DEBUG_INFO),
        ...
        SERIAL_STR_TYPE_MAP(DW_RADAR_DOPPLER_MOTION),
        SERIAL_STR_TYPE_MAP(DW_RADAR_SCAN),
        SERIAL_STR_TYPE_MAP(DW_RADAR_TRACK_EXTENDED),
        SERIAL_STR_TYPE_MAP(DW_RADAR_GRID_OBSTACLES),
        SERIAL_STR_TYPE_MAP(DW_RADAR_GRID_OCCUPANCY),
        ...
        SERIAL_STR_TYPE_MAP(DW_ERROR_SIGNAL),
        SERIAL_STR_TYPE_MAP(DW_GRAPH_ERROR_SIGNAL),
        ...
        SERIAL_STR_TYPE_MAP(DW_WAIT_GROUP_ARRAY),
        ...
        SERIAL_STR_TYPE_MAP(DW_SPEEDLIMIT_WORLD_MODEL),
        SERIAL_STR_TYPE_MAP(DW_SPEEDLIMIT_POSITIONAL_ARRAY),
        SERIAL_STR_TYPE_MAP(DW_SPEEDLIMIT_ATTRIBUTES_ARRAY),
        ...
        SERIAL_STR_TYPE_MAP(DW_MPPSELECTOROUTPUT),
        SERIAL_STR_TYPE_MAP(DW_TRAFFIC_LIGHT_ASSOCIATION_ARRAY),
        SERIAL_STR_TYPE_MAP(DW_CALIBRATED_IMU_INTRINSICS),
        SERIAL_STR_TYPE_MAP(DW_CALIBRATION_SUMMARY),
        SERIAL_STR_TYPE_MAP(DW_MODULE_INIT_PARAMETERS),
        SERIAL_STR_TYPE_MAP(DW_DXIS_FACE_DETECT_INFO),
        SERIAL_STR_TYPE_MAP(DW_DXIS_FACIAL_LANDMARK_INFO),
        SERIAL_STR_TYPE_MAP(DW_DXIS_EYE_OPEN_INFO),
        SERIAL_STR_TYPE_MAP(DW_DXIS_DROWSINESS_INFO),
        SERIAL_STR_TYPE_MAP(DW_DXIS_HEAD_POSE_INFO),
        SERIAL_STR_TYPE_MAP(DW_DXIS_GAZE_INFO),
        SERIAL_STR_TYPE_MAP(DW_DXIS_PERCLOS_SM_INFO),
        SERIAL_STR_TYPE_MAP(DW_ZONE_DETECTION_STATE),
        SERIAL_STR_TYPE_MAP(DW_LANE_TO_ZONE_DETECTION_STATE_ASSOCIATION_ARRAY),
        SERIAL_STR_TYPE_MAP(DW_CONTROL_SAFETY_MONITORING),
        SERIAL_STR_TYPE_MAP(DW_LANE_SUPPORT_SYSTEM_DEBUG),
    };
