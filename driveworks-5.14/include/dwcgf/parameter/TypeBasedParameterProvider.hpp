...
public:
    ...
    /// @see dw::framework::ParameterProvider::get(ParameterProvider const* const, dw::core::StringView const&, const std::type_info&, const std::type_info&, void*)
    ...
    /// @see dw::framework::ParameterProvider::get(ParameterProvider const* const, dw::core::StringView const&, size_t const, const std::type_info&, const std::type_info&, void*)
    // coverity[autosar_cpp14_a2_10_5_violation]
    bool get(
        ParameterProvider const* const parentProvider,
        dw::core::StringView const& key,
