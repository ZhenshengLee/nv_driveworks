...
#pragma GCC diagnostic pop
    ...
    /// on the output-timestmap option:
    /// output-timestmap=raw, then hostTimestamp will be overridden by sensorTimestamp
    /// output-timestmap=smoothed, then hostTimestamp will be smoothed
    ...
    /// For SAL user, you can specify output-timestmap=raw if you think sensorTimestamp is more reliable
    dwTime_t sensorTimestamp;

    /// Reserved
    uint8_t reserved[479];
} dwIMUFrame;
