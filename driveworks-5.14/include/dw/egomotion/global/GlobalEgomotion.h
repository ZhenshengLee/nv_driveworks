...
#include "GlobalEgomotionTypes.h"
...
typedef dwGlobalEgomotionGNSSCharacteristics dwGNSSCharacteristics;
 ...
 *
 * Valid GPS measurements must contain longitude, latitude and altitude signals. When present, the
 * data is further monitored with e.g. timestamp monotonicity checks.
 *
