...
typedef struct dwEgomotionResult
{
    ...
    float32_t linearVelocity[3];      //!< Linear velocity in body frame measured in [m/s] at the origin. For motion models capable of estimating slip angle imposed lateral velocity, y component will be populated. @note this represents instanteneous linear velocity
...
typedef struct dwEgomotionRelativeUncertainty
{
