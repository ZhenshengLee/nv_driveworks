...
//
////////////////////////////////////////////////////////////////////////////////
#ifndef DW_CONTROL_VEHICLEIO_VEHICLEIOLEGACYSTRUCTURES_H_
#define DW_CONTROL_VEHICLEIO_VEHICLEIOLEGACYSTRUCTURES_H_
// Generated by dwProto from vehicle_io_legacy_structures.proto DO NOT EDIT BY HAND!
...
typedef enum dwVehicleIOFaults {
    ...
    DW_VEHICLEIO_FAULT_MAX      = 2147483648, //!< UINT32_MAX
} dwVehicleIOFaults;
...
typedef enum dwVehicleIOOverrides {
    ...
    DW_VEHICLEIO_OVERRIDE_MAX      = 2147483648, //!< UINT32_MAX
...
/// @brief AEB - Automatic Emergency Braking System Status to report externally
...
/// @brief FCW - Forward Collision Warning Status to report externally
...
/// @brief CDW - Close Distance Warning Status to report externally
...
/// @brief BSM - Blind Spot Monitoring Request
...
/// @brief Trailer connected status
...
/// @brief Generic struct representing signal quality
...
typedef enum dwVehicleIOLongCtrlReferenceInputRequest {
    /// Idle
...
typedef enum dwVehicleIOLongCtrlInteractionModeRequest {
    /// Idle
...
typedef enum dwVehicleIOLongCtrlAccelPerfRequest {
    /// none
...
typedef enum dwVehicleIOLongCtrlSecureRequest {
...
// This amounts to max(VehicleIOLaneDepartureWarningState) + 1, i.e. the required size of
...
// This amounts to max(VehicleIOLaneDepartureWarningSide) + 1, i.e. the required size of
// an array if these enum values are interpreted as array offsets.
...
/// @brief brief The capability state data. Fields may not be populated if not supported by driver.
...
typedef struct dwVehicleIOState
{
    ...
    // Required by ESS/AES to avoid direct calculation of the derivative of the steering wheel angle.
...
#endif // DW_CONTROL_VEHICLEIO_VEHICLEIOLEGACYSTRUCTURES_H_
