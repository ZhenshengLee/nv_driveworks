...
if(NOT TRT_VERSION)
    if(VIBRANTE_PDK_VERSION)
        ...
        elseif(VIBRANTE_PDK_VERSION VERSION_EQUAL 6.0.5.1)
            set(TRT_VERSION 8.4.12.5)
        elseif(VIBRANTE_PDK_VERSION VERSION_EQUAL 6.0.6.0)
            set(TRT_VERSION 8.5.10.4)
        elseif(VIBRANTE_PDK_VERSION VERSION_EQUAL 6.0.6.1)
            set(TRT_VERSION 8.5.10.4)
        elseif(VIBRANTE_PDK_VERSION VERSION_EQUAL 6.0.7.0)
            set(TRT_VERSION 8.6.10.3)
        elseif(VIBRANTE_PDK_VERSION VERSION_EQUAL 6.0.8.0)
            set(TRT_VERSION 8.6.11.4)
        elseif(VIBRANTE_PDK_VERSION VERSION_GREATER_EQUAL 6.0.8.1)
            set(TRT_VERSION 8.6.11.4)
        else()
...
if(TRT_VERSION)
    ...
    elseif(TRT_VERSION VERSION_EQUAL 8.5.10.4)
        set(CUDNN_VERSION 8.6.0)
    elseif(TRT_VERSION VERSION_EQUAL 8.6.10.3)
        set(CUDNN_VERSION 8.9.0)
    elseif(TRT_VERSION VERSION_GREATER_EQUAL 8.6.11.4)
