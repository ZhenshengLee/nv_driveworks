...
#ifdef AV_BUILD_NON_PRODUCTION
    dwPlatformOS platform[] = {DW_PLATFORM_OS_LINUX, DW_PLATFORM_OS_V5L, DW_PLATFORM_OS_V5Q};
#else
#ifdef VIBRANTE_V5Q
    dwPlatformOS platform[] = {DW_PLATFORM_OS_V5Q};
#endif
#ifdef VIBRANTE_V5L
    dwPlatformOS platform[] = {DW_PLATFORM_OS_V5L};
#endif
#if defined(LINUX)
    dwPlatformOS platform[] = {DW_PLATFORM_OS_LINUX};
#endif
#endif
