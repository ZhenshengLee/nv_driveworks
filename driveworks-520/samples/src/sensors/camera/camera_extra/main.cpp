    ...
    bool onInitialize() override
    {
        ...
        // -----------------------------------------
        {
            ...
            if (m_recordCamera)
            {
                ...
                // Initialize Base serializers (raw/ISP0)
        ...
        /**
         * Needed Engines/Modules need to be enabled before requesting for associated attributes. 
         * In case of Camera Sensors, to request sensor attributes expects camera sensor to be
         * bootstrapped and available.
         * In case of Serialization, Serializers should be initialized before requesting for attributes.
         */
        if (m_bUseNvSciPath)
        {
