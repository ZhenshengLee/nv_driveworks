...
#include <dwvisualization/display/EGL.h>
#include <dwvisualization/gl/GL.h> // must keep this to prevent gl.h inclusion before glew.h
...
// create shared window context for the calling thread
    ...
    void setOnDropCallback(DropCallback callback)
    {
