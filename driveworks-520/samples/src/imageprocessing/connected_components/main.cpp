...
bool ConnectedComponentsApp::onInitialize()
{
    ...
    const std::string& protocolString = getArgument("protocol");

    dwSensorParams params{};
    if (!protocolString.empty())
    {
        std::cout << "Setting protocol to: " << protocolString << std::endl;
    ...
    ProgramArguments args(argc, argv,
                          {
                              ...
                              ProgramArguments::Option_t("protocol", "camera.virtual", "Protocol to be used "),
                          },
