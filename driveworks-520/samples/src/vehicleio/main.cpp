...
private:
    ...
    {
        return vioActuationFeedback.longCtrlStatus == DW_VIO_LONG_CTRL_STATUS_ERROR ||
...
public:
    ...
    void onRender() override
    {
        ...
        logBrakeThrottle << " brakeTorqueWheels[0]: " << m_actuationFeedback.brakeTorqueWheels[0] << "\n";
        logBrakeThrottle << " brakeTorqueWheels[1]: " << m_actuationFeedback.brakeTorqueWheels[1] << "\n";
        logBrakeThrottle << " brakeTorqueWheels[2]: " << m_actuationFeedback.brakeTorqueWheels[2] << "\n";
        logBrakeThrottle << " brakeTorqueWheels[3]: " << m_actuationFeedback.brakeTorqueWheels[3] << "\n";
        ...
        logMisc << "Miscellaneous"
                << "\n";
        logMisc << "\n";
        logMisc << " drivePositionStatus:  " << static_cast<uint32_t>(m_nonSafeState.drivePositionStatus) << "\n";
