...
#ifndef DW_POINTCLOUDPROCESSING_ASSEMBLER_POINTCLOUDASSEMBLER_H_
#define DW_POINTCLOUDPROCESSING_ASSEMBLER_POINTCLOUDASSEMBLER_H_
 ...
 * @param[in]  obj                        Module handle
 * @return DW_SUCCESS            - if successfully bound output point cloud<br>
 ...
 *         DW_INVALID_HANDLE     - if given handle is invalid<br>
 *         DW_INVALID_ARGUMENT   - if trying to bind GPU point cloud when cuda is not
 *                                 is not enabled at initialization or mapping structure is not correct<br>
 *
 * @note Mapping structures within a point cloud must match or extend mapping specified at initialization.<br>
 * @par API Group
 * - Init: Yes
 * - Runtime: Yes
 * - De-Init: Yes
...
#endif
/** @} */
#endif // DW_POINTCLOUDPROCESSING_ASSEMBLER_POINTCLOUDASSEMBLER_H_
