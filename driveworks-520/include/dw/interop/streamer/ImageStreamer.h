 ...
 *
 * @return DW_INVALID_HANDLE if the given context handle is null, <br>
 ...
 *         DW_INVALID_HANDLE if the given context handle is null  <br>
...
dwStatus dwImageStreamer_initializeCrossProcessEGL(dwImageStreamerHandle_t* streamer,
                                                   dwImageProperties const* from, dwImageType to,
                                                   dwImageStreamerCrossProcessModeParams params,
                                                   dwContextHandle_t ctx);
#endif
 ...
 * @param[in] streamer A handle to the image streamer.
 *
 * @return DW_INVALID_HANDLE if the given streamer handle (producer) is null <br>
 ...
 * @param[in] streamer A handle to the image streamer.
 *
 * @return DW_INVALID_HANDLE if the given streamer handle (consumer) is null <br>
