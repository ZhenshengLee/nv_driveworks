...
typedef struct dwVehicleAxleProperties
{
    ...
    /// Nominal value of radius of left wheel, when facing towards the forward direction
    /// of the vehicle.
    /// @note unit m
    float32_t nominalWheelRadiusLeft;

    /// Nominal value of radius of right wheel, when facing towards the forward direction
    /// of the vehicle.
    /// @note unit m
...
typedef struct dwVehicleActuationProperties
{
    ...
    /// @deprecated throttleActuatorTimeConstant is deprecated, please use accelerationTimeConstant_s instead.
    DW_DEPRECATED("throttleActuatorTimeConstant is deprecated, please use accelerationTimeConstant_s instead.")
    float32_t throttleActuatorTimeConstant;

    /// Time delay for first order + time delay throttle system [s].
    /// @deprecated throttleActuatorTimeDelay is deprecated, please use accelerationTimeDelay_s instead.
    DW_DEPRECATED("throttleActuatorTimeDelay is deprecated, please use accelerationTimeDelay_s instead.")
    float32_t throttleActuatorTimeDelay;

    /// Time constant for first order + time delay brake system [s].
    /// @deprecated brakeActuatorTimeConstant is deprecated, please use decelerationTimeConstant_s instead.
    DW_DEPRECATED("brakeActuatorTimeConstant is deprecated, please use decelerationTimeConstant_s instead.")
    float32_t brakeActuatorTimeConstant;

    /// Time delay for first order + time delay brake system [s].
    /// @deprecated brakeActuatorTimeDelay is deprecated, please use decelerationTimeDelay_s instead.
    DW_DEPRECATED("brakeActuatorTimeDelay is deprecated, please use decelerationTimeDelay_s instead.")
    float32_t brakeActuatorTimeDelay;

    /// Time constant for first order + time delay drive-by-wire / steer-by-wire [s].
    /// @deprecated driveByWireTimeConstant is deprecated, please use frontWheelAngleTimeConstant_s instead.
    DW_DEPRECATED("driveByWireTimeConstant is deprecated, please use frontWheelAngleTimeConstant_s instead.")
    float32_t driveByWireTimeConstant;

    /// Time delay for first order + time delay drive-by-wire / steer-by-wire [s].
    /// @deprecated driveByWireTimeDelay is deprecated, please use frontWheelAngleTimeDelay_s instead.
    DW_DEPRECATED("driveByWireTimeDelay is deprecated, please use frontWheelAngleTimeDelay_s instead.")
    float32_t driveByWireTimeDelay;

    /// Natural frequency for second order + time delay drive-by-wire / steer-by-wire [hz]
    /// @deprecated driveByWireNaturalFrequency is deprecated
    DW_DEPRECATED("driveByWireNaturalFrequency is deprecated")
    float32_t driveByWireNaturalFrequency;

    /// Damping ratio for second order + time delay drive-by-wire / steer-by-wire [unitless]
    /// @deprecated driveByWireDampingRatio is deprecated
    DW_DEPRECATED("driveByWireDampingRatio is deprecated")
    float32_t driveByWireDampingRatio;

    /// Indicates whether the drive-by-wire / steer-by-wire is second-order or not.
    /// @deprecated driveByWireSecondOrder is deprecated
    DW_DEPRECATED("driveByWireSecondOrder is deprecated")
