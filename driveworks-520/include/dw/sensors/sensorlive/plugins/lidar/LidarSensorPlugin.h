...
/**
 * @file
 * <b>NVIDIA DriveWorks: Lidar Sensor Plugin Interface to interact with live sensors</b>
 *
 * @b Description: This file defines the interfaces to be implemented for Lidar sensor plugins.
 */

#ifndef DW_SENSORS_SENSORLIVE_LIDAR_LIDARSENSORPLUGIN_H
#define DW_SENSORS_SENSORLIVE_LIDAR_LIDARSENSORPLUGIN_H
...
typedef struct dwLidarSensorPluginFunction
{
...
#endif // DW_SENSORS_SENSORLIVE_LIDAR_LIDARSENSORPLUGIN_H
