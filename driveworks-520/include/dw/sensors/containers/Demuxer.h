...
typedef struct dwDemuxerFrameInfo
{
    ...
    // and timestamps. If the internal file structure of the container makes it impossible to provide this
    // information, both containerOffset and containerSize will be zero.
