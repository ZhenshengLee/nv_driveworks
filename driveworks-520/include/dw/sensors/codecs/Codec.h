...
#ifndef DW_SENSORS_CODECS_CODEC_H_
#define DW_SENSORS_CODECS_CODEC_H_
...
/// flag to indicate when a complete picture is sent to the decoder
/// this will start frame decode immediately instead of waiting on
/// the next frame to arrive to decode current frame
...
typedef enum {
    ...
    DW_MEDIA_TYPE_METADATA   = 10, ///< type of metadata
    DW_MEDIA_TYPE_COUNT      = 11  ///< type of count
} dwMediaType;
...
typedef struct dwCodecMimeType
{
    /// Codec MIME type
...
extern dwCodecMimeTypeConst_t const DW_CODEC_MIME_TYPE_VIDEO_H265_ANNEX_B;
...
extern dwCodecMimeTypeConst_t const DW_CODEC_MIME_TYPE_ULTRASONIC_CONTI_CUS3_OBJECT;
...
extern dwCodecMimeTypeConst_t const DW_CODEC_MIME_TYPE_KINECT;

/// Codec Capability
typedef enum {
    DW_CODEC_CAPABILITY_HARDWARE    = 0, //!< Codec Capability for hardware
    DW_CODEC_CAPABILITY_SOFTWARE    = 1, //!< Codec Capability for software
    DW_CODEC_CAPABILITY_UNSUPPORTED = 2, //!< unsupported Codec Capability
} dwCodecCapability;
...
/**
 * @brief Encoder rate control parameters
 *
 */
...
/**
 * @brief Encoder specific configs
 *
 */
...
/** @} */
#endif // DW_SENSORS_CODECS_CODEC_H_
