...
#ifndef DW_SENSORS_CODECS_CODECHEADER_H_
#define DW_SENSORS_CODECS_CODECHEADER_H_
...
*
* @return DW_SUCCESS return successfully.
*
*/
...
/** @} */
#endif // DW_SENSORS_CODECS_CODECHEADER_H_
