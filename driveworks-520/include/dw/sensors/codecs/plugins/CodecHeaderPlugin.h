...
* @param[in] handle The handle to a CodecHeader created previously with the 'dwCodecHeaderPlugin_initializeHandle' interface.
*
* @return DW_SUCCESS if call is successful.
*/
...
*
* @return DW_INVALID_ARGUMENT if data or handle is nullptr<br>
* 		  DW_FAILURE if the CodecHeader can't load the given serialized data <br>
*         DW_SUCCESS if call is successful.
*/
...
*
* @return DW_INVALID_ARGUMENT if handle or ctx is nullptr<br>
*         DW_SUCCESS if call is successful.
*/
