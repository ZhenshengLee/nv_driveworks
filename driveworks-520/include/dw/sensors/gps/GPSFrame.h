...
/// @brief The GPS jam state gives jamming state detected by the GNSS-receiver.
typedef enum dwGPSJamState {
...
/// @brief The GPS spoof state gives spoofing-state detected by the GNSS-receiver.
typedef enum dwGPSSpoofState {
...
typedef struct dwGPSFrame
{
    ...
    /// @note ID VS-91180
    /// @note description Accuracy of GNSS-course estimated by GNSS-receiver.
    /// @note TODO: Backend not yet implemented
    /// @note min 0    max 359.9985
    /// @note freq 4    unit deg
    float64_t courseAccuracy;

    /// @note ID VS-91190
    /// @note description Accuracy of GNSS-speed estimated by GNSS-receiver.
    /// @note TODO: Backend not yet implemented
    /// @note min 0    max 131.069
    /// @note freq 4    unit m/s
    float64_t speedAccuracy;

    /// @note ID VS-91200
    /// @note description GPS Jamming state detected by the GNSS-receiver.
    /// @note TODO: Backend not yet implemented
    /// @note min nan    max nan
    /// @note freq 4    unit unitless
    /// @note *** valid values**: {
    ///                GPS_JAM_STATE_UNSPECIFIED,
    ///                GPS_JAM_STATE_OK,
    ///                GPS_JAM_STATE_WARN,
    ///                GPS_JAM_STATE_CRITICAL,
    ///                GPS_JAM_STATE_INIT
    ///        }
    dwGPSJamState jamState;

    /// @note ID VS-91210
    /// @note description GPS Spoofing-state detected by the GNSS-receiver.
    /// @note TODO: Backend not yet implemented
    /// @note min nan    max nan
    /// @note freq 4    unit unitless
    /// @note *** valid values**: {
    ///                GPS_SPOOF_STATE_UNSPECIFIED,
    ///                GPS_SPOOF_STATE_NO,
    ///                GPS_SPOOF_STATE_YES,
    ///                GPS_SPOOF_STATE_MULTI,
    ///                GPS_SPOOF_STATE_INIT
    ///        }
