...
typedef enum dwEgomotionManeuverMotionType {
    ...
    DW_EGOMOTION_MANEUVER_MOTIONTYPE_FORWARD_AND_DYNAMIC_OBJECT = 5,
...
typedef struct dwEgomotionPose
{
    ...
    // Timestamp of *computation*, not timestamp of validity. Warning!
...
/// @brief Struct representing extrinsics calibration with validity.
typedef struct dwEgomotionCalibratedExtrinsics
{
