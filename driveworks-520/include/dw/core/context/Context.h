...
/// @brief The Driveworks context handle
 ...
 * @param[in] streamIndex CUDA stream index
 * @param[in] context Specifies the context handle.
 *
 * @return DW_INVALID_ARGUMENT if context handle, driverVersion or apiVersion are NULL. <br>
 *         DW_SUCCESS if no error occurs.
 ...
 */
DW_API_PUBLIC
dwStatus dwContext_getCUDAStream(cudaStream_t* stream, uint32_t streamIndex, dwContextHandle_t const context);
 ...
 */
DW_API_PUBLIC
DW_DEPRECATED("Display and EGL related context is moved to src/dwvisualization, please replace this call with dwVisualization_setEGLDisplay.")
 ...
 **/
DW_API_PUBLIC
DW_DEPRECATED("Display and EGL related context is moved to src/dwvisualization, please replace this call with dwVisualization_getEGLDisplay.")
 ...
 * @param[in] context Specifies the context handle.
 *
 * @return DW_INVALID_ARGUMENT if mod or context is NULL. <br>
 ...
 * @param[in] context Specifies the context handle.
 *
 * @return DW_INVALID_ARGUMENT if mod or context is NULL.
