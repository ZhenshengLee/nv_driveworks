...
/**
 * Memory copy of virtual process memory. This subroutine shall call std::memcpy() for x86_64, and custom optimized implementation
 * for aarch64. As in standard memcpy call destination and source memory blocks should not overlap.
 *
 * NOTE: This function shall be used only if the source address belongs to a CUDA Pinned Host memory region.
 ...
 *
 * @note The method has been deprecated and replaced by standard std::memcpy() implementation due to safety concerns.
 *
 ...
 */
DW_API_PUBLIC
DW_DEPRECATED("memcpy_opt is deprecated, refer to standard memcpy or cudaMemcpy APIs")
