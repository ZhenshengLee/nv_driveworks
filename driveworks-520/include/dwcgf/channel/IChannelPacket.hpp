...
public:
    ...
    /**
     * Additional interfaces needed by remote shmem channels
     */
    class RemoteShmemCallbacks
    {
    public:
        /**
         * Get the maximum size of the flat-buffer payload.
         * @return size_t
         */
        virtual size_t getBufferSize() = 0;
        /**
        ...
        /**
         * Initialize the packet from the given raw memory
         *
        ...
        /**
         * Pack the packet into the flat buffer.
         */
        virtual void pack() = 0;
        /**
         * Unpack the packet from the flat buffer.
         */
    ...
    /**
     * Get the remote-shmem-specific interfaces for the packet.
     *
     * @return RemoteShmemCallbacks&
     */
...
{
public:
    explicit ChannelPacketDefaultBase(size_t typeSize);
...
{
public:
    explicit ChannelPacketDefault(size_t typeSize);
...
// coverity[autosar_cpp14_a0_1_6_violation]
class ChannelRemoteShmemPacketDefault : public IChannelPacket, public IChannelPacket::RemoteShmemCallbacks
{
    // coverity[autosar_cpp14_a0_1_1_violation]
    // coverity[autosar_cpp14_a2_10_5_violation]
    static constexpr char LOG_TAG[]{"ChannelRemoteShmemPacketDefault"};
...
public:
    explicit ChannelNvSciPacketDefault(size_t typeSize);
