...
constexpr PassDescriptorT<0> describePass(
    dw::core::StringView&& name, dwProcessorType processorType)
{
...
// coverity[autosar_cpp14_a2_10_5_violation] FP: nvbugs/3907242
constexpr auto describePassWithCustomDependencies(
    dw::core::StringView&& name, dwProcessorType processorType, DependenciesT&& dependencies) -> PassDescriptorT<std::tuple_size<DependenciesT>::value>
{
...
{
    return std::tuple_size<decltype(describeNodePasses<Node>())>::value;
}
...
template <
    ...
    constexpr std::size_t passIndex(dw::core::StringView identifier)
{
    constexpr dw::core::StringView name{std::get<Index>(describeNodePasses<Node>()).name};
    if (name == identifier)
    {
        // coverity[autosar_cpp14_a5_1_1_violation] RFD Accepted: TID-2056
        return 0U;
...
{
    return isValidPassIndex<Node>(passIndex<Node>(identifier));
}
...
{
    return std::get<Index>(describeNodePasses<Node>()).name;
}
...
{
    return std::get<Index>(describeNodePasses<Node>()).processorType;
}
...
{
    return std::get<Index>(describeNodePasses<Node>()).hasDependencies;
}
...
{
    return std::get<Index>(describeNodePasses<Node>()).dependencies;
}
