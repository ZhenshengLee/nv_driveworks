...
/**
 * @brief Parameters for dwSelfCalibrationWheelRadiiSelectorNode
 */
...
/**
 * @brief This node selects wheel radii output from multiple inputs
 *
 * @ingroup dwnodes
 */
...
public:
    ...
    static constexpr auto describeParameters()
    {
        ...
        return describeConstructorArguments(
            describeConstructorArgument<dwSelfCalibrationWheelRadiiSelectorNodeParams>(
                // TODO(lmoltrecht): AVC-2657 Fill with necessary parameters
                ),
    ...
    dwSelfCalibrationWheelRadiiSelectorNode(dwSelfCalibrationWheelRadiiSelectorNodeParams const& param, dwContextHandle_t const /*ctx*/);
};
} // namespace framework
} // namespace dw
