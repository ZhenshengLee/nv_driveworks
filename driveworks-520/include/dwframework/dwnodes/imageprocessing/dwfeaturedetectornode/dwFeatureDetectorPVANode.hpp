...
class dwFeatureDetectorPVANode : public dwFeatureDetectorNodeBase, public IChannelsConnectedListener
{
...
public:
    ...
    static constexpr auto describeParameters()
    {
        ...
        return describeConstructorArguments(
            describeConstructorArgument<dwFeatureDetectorNodeParams>(
            ...
            describeConstructorArgument<dwFeatureDetectorNodeRuntimeParams>(
                DW_DESCRIBE_INDEX_PARAMETER(
                    cudaStream_t,
                    "streamIndex"_sv,
