...
#ifndef DWFRAMEWORK_DWNODES_SENSORS_DWGPSNODE_DWGPSCHANNELNODE_HPP_
#define DWFRAMEWORK_DWNODES_SENSORS_DWGPSNODE_DWGPSCHANNELNODE_HPP_
...
public:
    ...
    static constexpr char8_t LOG_TAG[]{"dwGPSChannelNode"};
    ...
    dwGPSChannelNode(const char* sensorName, dwConstRigHandle_t rigHandle, dwSALHandle_t sal, dwContextHandle_t ctx, const FixedString<32>& frameSkipMask, bool errorHandlingEnabled = false);
...
#endif // DWFRAMEWORK_DWNODES_SENSORS_DWGPSNODE_DWGPSCHANNELNODE_HPP_
