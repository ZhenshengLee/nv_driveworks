...
#ifndef DWFRAMEWORK_DWNODES_SENSORS_DWIMUNODE_DWIMUNODE_HPP_
#define DWFRAMEWORK_DWNODES_SENSORS_DWIMUNODE_DWIMUNODE_HPP_
...
public:
    ...
    static constexpr auto describeInputPorts()
    {
        ...
        return describePortCollection(
            ...
            DW_DESCRIBE_PORT(dwIMUFrame, "FRAME"_sv, PortBinding::REQUIRED));
    };
    // coverity[autosar_cpp14_a7_1_5_violation] RFD Accepted: TID-2201
    static constexpr auto describeOutputPorts()
    {
        ...
        return describePortCollection(
            ...
            DW_DESCRIBE_PORT(dwValTimestampMetadata, "VAL_TIMESTAMP_METADATA"_sv, PortBinding::REQUIRED),
    ...
    static constexpr auto describeParameters()
    {
        ...
        return describeConstructorArguments(
            describeConstructorArgument<dwIMUNodeParams>(
                ...
                DW_DESCRIBE_PARAMETER(
                    ...
                    "frameSkipMask"_sv,
                    &dwIMUNodeParams::frameSkipMask),
                DW_DESCRIBE_PARAMETER_WITH_DEFAULT(
                    bool,
                    "errorHandlingEnabled"_sv,
                    false,
                    &dwIMUNodeParams::errorHandlingEnabled)),
...
#endif // DWFRAMEWORK_DWNODES_SENSORS_DWIMUNODE_DWIMUNODE_HPP_
