...
public:
    ...
    static constexpr auto describeParameters()
    {
        ...
        return describeConstructorArguments(
            describeConstructorArgument<VehicleStateNodeNewParams>(
                ...
                DW_DESCRIBE_PARAMETER(bool, "asilState"_sv, &VehicleStateNodeNewParams::asilState),
                DW_DESCRIBE_PARAMETER(bool, "qmState"_sv, &VehicleStateNodeNewParams::qmState),
                ...
                DW_DESCRIBE_UNNAMED_PARAMETER_WITH_SEMANTIC(bool, semantic_parameter_types::Virtual, &VehicleStateNodeNewParams::isVirtual),
    ...
    dwVehicleStateChannelNewNode(VehicleStateNodeNewParams const& params, const char* sensorName, dwConstRigHandle_t rigHandle,
                                 dwSALHandle_t sal, dwContextHandle_t ctx, bool errorHandlingEnabled = false);
};
}
}
