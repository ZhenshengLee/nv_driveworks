...
using dwRigNodeParams = struct dwRigNodeParams
{
    ...
    // must be less than rigWriteTimerPeriodInCycles for serialization to occur.
 ...
 * @ingroup dwnodes
 */
class dwRigNode : public ExceptionSafeProcessNode
{
public:
    ...
    static constexpr auto describeParameters()
    {
        ...
        return describeConstructorArguments(
            describeConstructorArgument<dwRigNodeParams>(
                ...
                DW_DESCRIBE_PARAMETER_WITH_DEFAULT(uint64_t, "rigWriteTimerPeriodInCycles"_sv, 0, &dwRigNodeParams::rigWriteTimerPeriodInCycles),
                DW_DESCRIBE_PARAMETER_WITH_DEFAULT(uint64_t, "rigWriteTimerOffsetInCycles"_sv, 0, &dwRigNodeParams::rigWriteTimerOffsetInCycles)),
