...
{
    static constexpr EnumDescriptionReturnType<
        dwImageType,
#ifdef VIBRANTE
        4
#else
...
{
    static constexpr EnumDescriptionReturnType<dwImageFormat, 37> get()
    {
...
{
    static constexpr EnumDescriptionReturnType<dwImageMemoryType, 3> get()
    {
...
{
    static constexpr EnumDescriptionReturnType<dwFovealMode, 3> get()
    {
...
{
    static constexpr EnumDescriptionReturnType<dwPrecision, 4> get()
    {
...
{
    static constexpr EnumDescriptionReturnType<dwProcessorType, 12> get()
    {
        return describeEnumeratorCollection<dwProcessorType>(
            ...
            DW_DESCRIBE_C_ENUMERATOR(DW_PROCESSOR_TYPE_VIC_LDC),
            DW_DESCRIBE_C_ENUMERATOR(DW_PROCESSOR_TYPE_VIC_NV2D));
    }
};
...
{
    static constexpr EnumDescriptionReturnType<dwSensorType, 9> get()
    {
...
{
    static constexpr EnumDescriptionReturnType<dwTrivialDataType, 14> get()
    {
