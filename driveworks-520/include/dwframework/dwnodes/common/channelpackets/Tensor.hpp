...
protected:
    dwDNNTensorHandle_t m_dispatchTensor{};

private:
    dwDNNTensorHandle_t m_tensorHandle{};
};
...
private:
    ...
    std::unique_ptr<TensorSerializer> m_tensorSerializer{};
    std::unique_ptr<TensorDeserializer> m_tensorDeserializer{};
};
