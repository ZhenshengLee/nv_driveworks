...
public:
    ...
    /**
     * @brief Constructor for BadVariantAccess.
     *
    ...
    */
    ...
    /**
     * @brief Destructor for BadVariantAccess.
     *
     * Access specifier: public
    */
...
/**
 * @brief Get the type at the zero-based @c Index of the @c TVariant. If @c TVariant is a @ref Variant and @c Index is a valid
...
/**
 * @brief A type-safe discriminated union. Like types defined by the @c union keyword, the same memory region is used to store
 ...
 * @note This class is as close to compatible with @c std::variant while staying AUTOSAR compliant. In general, this means
    ...
    : private detail::VariantImpl<Types...>
{
    ...
    /// User access to the implementation of Variant
...
public:
    /**
     * @brief The default constructor is only enabled if the first type of @c Types has a default constructor. This operation
    ...
    */
    ...
    /**
     * @brief The copy constructor is enabled only if all @c Types have a copy constructor. This constructor is trivial if all
    ...
    */
    ...
    /**
     * @brief The move constructor is enabled if all @c Types have a move constructor or, for those that do not, there is a
    ...
    */
    ...
    /**
     * @brief Construct the variant as the alternative with the given @c Index using the specified @a args. This function only
    ...
    */
    ...
    /**
     * @brief Construct the variant as the @c T alternative using the specified @a args. This function only participates in
    ...
    */
    ...
    /**
     * @brief Convert from a given @a src. This function only participates in overload resolution when the decayed form of
    ...
    */
    ...
    /**
     * @brief The copy-assignment operator is enabled if all @c Types have a copy-constructor and a copy-assignment operator.
     *        The requirement on having a copy-constructor comes from assignment on type-changing operators, which are
    ...
    */
    ...
    /**
     * @brief The move-assignment operator is enabled if all @c Types have a move-constructor and a move-assignment operator
    ...
    */
    ...
    /**
     * @brief Assign from a given @a src. This function only participates in overload resolution when the decayed form of
     *        @c T is neither a @c Variant, a specialization of @c in_place_type_t or @c in_place_index_t, and there is only
    ...
    */
    ...
    /**
     * @brief The destructor is trivial if all alternative @c Types have trivial destructors.
     *
     * Access specifier: public
    */
    ~Variant() = default;
    ...
    /**
     * @brief Return the zero-based index of the alternative currently contained in this instance or VARIANT_NPOS if the
    ...
    */
    ...
    /**
     * @brief Check if this instance is valueless. This can happen in cases where a type-changing assignment or @ref emplace
    ...
    */
    ...
    /**
     * @brief Construct the alternative with the given @c Index using the provided @a args through direct initialization. If
    ...
    */
    ...
    /**
     * @brief Construct the alternative with the given @c T using the provided @a args through direct initialization. If there
    ...
    */
    ...
    /**
     * @brief Swap the contents of this instance with @a other.
     *
     * Access specifier: public
    */
...
/**
 * @brief This class gives users access to the implementation of @ref Variant, bypassing the fact that @c detail::VariantImpl
...
/**
 * @brief Get the value of @a src as the type specified by @c Index if the current alternative matches @c Index.
...
/**
 * @brief Get the value of @a src as @c T if @c T is the current alternative. This overload is only enabled if @c T appears
 *        exactly once in the @c Types list.
...
/// @{
/**
 * @brief Get the value of @a src as the type specified by the @c Index.
...
/// @{
/**
 * @brief Get the value of @a src as the specified type @c T. This overload is only enabled if @c T appears exactly once in
 *        the @c Types list.
...
/**
 * @brief Test if the given @a value holds the type @c T. This function is only enabled if @c T appears exactly once in the
...
/// @{
/**
 * @brief Invoke a @a visitor function with the active type in the @a value variant.
 ...
 * @note The equivalent @c std::visit function overload for @c std::variant allows for an arbitrary number of instances
