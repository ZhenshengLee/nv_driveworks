...
/**
 * @brief Implements a static assert for classes to check if its data size is equal to a specified size during compile-time.
 *
 * @note A compile-time error will occur when the expected size is not equal to the actual size.
 *
 * @tparam T The type to check.
 * @tparam EXPECTEDSIZE The expected size.
 * @tparam ACTUALSIZE The actual size.
 * 
 * @return true
*/
// For example:
...
/**
 * @brief Implements a static assert for classes to check if its data size is less than a specified size during compile-time.
 *
 * @note A compile-time error will occur when the actual size is less than the expected size.
 *
 * @tparam T The type to check.
 * @tparam EXPECTEDSIZE The expected size.
 * @tparam ACTUALSIZE The actual size.
