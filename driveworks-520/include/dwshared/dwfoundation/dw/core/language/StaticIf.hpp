...
/// @{
/**
 * @brief If @c Cond::value is @c true, invoke the @a action with the provided @a args.
*/
...
/// @{
/**
 * @brief If @c Cond::value is @c false, invoke the @a action with the provided @a args.
*/
template <typename Cond, typename T, typename... Args>
// coverity[autosar_cpp14_a1_1_1_violation] RFD Pending: TID-2194
...
// std::forward() doesn't have decltype in it. Actually the static_cast<T&&>()
// inside std::forward() is what triggers this violation.
...
/**
 * @brief If @c Cond::value is @c true, invoke the @a trueAction with the provided @a args;
 * if @c Cond::value is @c false, invoke the @a falseAction with the provided @a args.
*/
