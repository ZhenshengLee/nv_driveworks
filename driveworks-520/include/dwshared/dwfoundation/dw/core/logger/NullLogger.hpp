...
#include <dwshared/dwfoundation/dw/core/logger/LoggerBase.hpp>
...
public:
     ...
     */
    using Logger::get;
    /// @brief Return the currently set global logger instance
    static NullLogger& get();

    /// @brief No timestamp is recorded (function is empty).
    void logTimestamp(LoggerMessageInfo const&) final
    {
    }

    /// @brief No log is done (function is empty).
