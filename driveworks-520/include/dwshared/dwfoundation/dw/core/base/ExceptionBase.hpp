...
public:
    ...
    {
        MessageInitializer<decltype(m_what), Tothers...> msgInitializer{m_what, std::forward<Tothers>(others)...};
        static_cast<void>(msgInitializer);
    }
...
protected:
    ...
    struct MessageInitializer<W, T, Tothers...>
    {
        ...
        {
            AppendToWhat<W, T> appendObject{m_what, std::forward<T>(first)};
            MessageInitializer<W, Tothers...> msgInitializer{m_what, std::forward<Tothers>(others)...};

            static_cast<void>(appendObject);
            static_cast<void>(msgInitializer);
        }
    };
