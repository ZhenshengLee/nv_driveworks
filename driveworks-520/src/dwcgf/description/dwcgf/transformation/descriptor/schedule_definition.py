...
class EpochDefinition:
    ...
    def monitoring_period(self) -> int:
        """Return the monitoring threshold of this EpochDefinition."""
        if self._monitoring_period is None:
            return 0
        return self._monitoring_period

    @monitoring_period.setter
    def monitoring_period(self, new_monitoring_period: int) -> None:
        """Set the monitoring threshold of this EpochDefinition."""
        self._monitoring_period = new_monitoring_period
    ...
    def to_json_data(self) -> OrderedDict:
        ...
        if self._monitoring_period is not None and self._monitoring_period > 0:
            epoch_json["monitoringPeriod"] = self._monitoring_period

        if self.frames != 1:
            epoch_json["frames"] = self.frames
        epoch_json["passes"] = [list(sorted(x)) for x in self.passes]
...
class HyperepochDefinition:
    ...
    def __init__(
        ...
        *,
        name: str,
        period: Optional[int],
        epochs: Optional[Dict[str, EpochDefinition]] = None,
    ...
    def period(self) -> int:
        ...
        if self._period is None:
            return max([e.period * e.frames for _, e in self._epochs.items()])
        else:
            return self._period
    ...
    @property
    def monitoring_period(self) -> int:
        """Return the monitoring threshold of this HyperepochDefinition."""
        if self._monitoring_period is None:
            return 0
        return self._monitoring_period
    ...
    @monitoring_period.setter
    def monitoring_period(self, new_monitoring_period: int) -> None:
        """Set the monitoring threshold of this HyperepochDefinition."""
        self._monitoring_period = new_monitoring_period
    ...
    def to_json_data(self) -> OrderedDict:
        ...
        if self._monitoring_period is not None and self._monitoring_period > 0:
            hyperepoch_json["monitoringPeriod"] = self._monitoring_period
...
class ScheduleDefinition:
    ...
    def __init__(
        ...
        *,
        ...
        monitored_passes: Optional[Dict[str, int]] = None,
    ):
        ...
        self._monitored_passes = monitored_passes
    ...
    def priority(self) -> Optional[int]:
        """Return priority of this schedule."""
        return self._priority

    @priority.setter
    def priority(self, value: int) -> None:
        """Set the priority of this schedule."""
    ...
    @property
    def monitored_passes(self) -> Optional[Dict[str, int]]:
        """Return a dict of pfm monitored passes.

        The key is the pass ID, the value is the monitoring threshold in nanoseconds.
        """
        return self._monitored_passes

    @monitored_passes.setter
    def monitored_passes(self, new_monitored_passes: Dict[str, int]) -> None:
        """Set the new monitored passes."""

        self._monitored_passes = new_monitored_passes
    ...
    def from_json_data(cls, name: str, content: Dict) -> "ScheduleDefinition":
        ...
        hyperepochs = {
            name: HyperepochDefinition(
                name=name,
                period=hyperepoch.get("period", None),
                monitoring_period=hyperepoch.get("monitoringPeriod", None),
                epochs={
                    epoch_name: EpochDefinition(
                        ...
                        monitoring_period=epoch_raw.get("monitoringPeriod", None),
                    )
        ...
        return ScheduleDefinition(
            ...
            priority=content.get("initOrder", None),
            monitored_passes=content.get("monitoredPasses", None),
        )
    ...
    def to_json_data(self) -> OrderedDict:
        ...
        passDependencies: OrderedDict = OrderedDict()
        ...
        if self.priority is not None:
            schedule_json["initOrder"] = self.priority

        if self.monitored_passes:
            schedule_json["monitoredPasses"] = self.monitored_passes
