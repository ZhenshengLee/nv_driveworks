...
class ParameterDefinition:
    ...
    def __init__(
        ...
        *,
        ...
        @param comment        comment for the parameter
        """
        self._name = name
        ...
        if default_value is not None:  # defalut is provided, check the sizes
            if self._array_size is None:
                ...
                if self._array_size != len(default_value):
                    raise ValueError(
                        "array parameter size is mismatch with default value size"
                    )
    ...
    def comment(self) -> Optional[str]:
        """Return comment for the parameter."""
        ...
        def dump_parameters(parameters: Dict[str, ParameterDefinition]) -> OrderedDict:
            ...
            for k, v in parameters.items():
                ...
                if v.comment is not None:
                    parameters_json[k]["comment"] = v.comment
