...
class RoadCastService:
    ...
    @staticmethod
    def from_descriptor(
        desc: RoadCastServiceDescriptor,
    ) -> "RoadCastService":
...
class EpochSyncService:
    ...
    def __init__(self, parameters: Dict[str, Dict], passes: List[str]):
...
class ProcessServices:
    ...
    def from_definition(
        ...
        if pro_def.services is None:
            return None
        if loader is None:
            raise ValueError("Process service is defined but the given loader is None.")
        rcs = None
    ...
    def to_definition(self) -> Dict[str, ProcessServiceDefinition]:
        ...
        if self.rcs:
            services_def["RoadCastService"] = ProcessServiceDefinition(
                ...
                # RoadCastService doesn't use framework pass anymore
                passes=[],
            )
        if self.sync:
...
class Process:
    ...
    def from_descriptor(
        ...
        return Process(
            ...
            data=deepcopy(desc.data) if desc.data is not None else None,
        )
    ...
    def to_descriptor(self) -> ProcessDefinition:
        ...
        return ProcessDefinition(
            ...
            data=deepcopy(self.data) if self.data is not None else None,
        )
