...
public:
    ...
    void getRequired(dw::core::StringView const& key, T* out) const
    {
        ...
        {
            throw Exception(DW_NOT_AVAILABLE, "Required parameter not available: ", key);
        }
    }
    ...
    bool getOptional(dw::core::StringView const& key, T* out) const
    {
        ...
        {
            throw Exception(e.status(), "Failed to get parameter by name: ", key, " - ", e.messageStr());
        }
    }
    ...
    bool getOptional(dw::core::StringView const& key, size_t const index, T* out) const
    {
        ...
        {
            throw Exception(e.status(), "Failed to get parameter by name and index: ", key, "[", index, "] - ", e.messageStr());
        }
    }
    ...
    bool get(dw::core::StringView const& key, T* out) const
    {
        ...
        if (value.size() != size)
        {
            throw Exception(DW_FAILURE, "Array sizes don't match");
        }
    ...
    bool getOptional(dw::core::StringView const& key, T* out) const
    {
        ...
        catch (Exception& e)
        {
            if (key.empty())
            {
                throw Exception(e.status(), "Failed to get unnamed parameter with mangled semantic type: ", typeid(S).name(), " - ", e.messageStr());
            }
            else
            {
                throw Exception(e.status(), "Failed to get parameter with semantic by name: ", key, " - ", e.messageStr());
            }
        }
    }
    ...
    bool getOptional(dw::core::StringView const& key, size_t const index, T* out) const
    {
        ...
        catch (Exception& e)
        {
            if (key.empty())
            {
                throw Exception(e.status(), "Failed to get unnamed parameter with mangled semantic type and index: ", typeid(S).name(), " ", index, " - ", e.messageStr());
            }
            else
            {
                throw Exception(e.status(), "Failed to get parameter with semantic by name and index: ", key, " ", index, " - ", e.messageStr());
            }
        }
    }
    ...
    bool get(dw::core::StringView const& key, T* out) const
    {
        ...
        // TODO(dirkt) to be commented in once all usage has been removed
    ...
    bool get(dw::core::StringView const& key, dw::core::FixedString<N>* out) const
    {
        ...
        if (success)
        {
            if (N <= str.size())
            {
                throw Exception(DW_BUFFER_FULL, "The FixedString parameter '", key, "' has a maximum capacity of N=", N, " but the value has a length of ", str.size() + 1, "(including trailing \\0)");
            }
    ...
    bool get(dw::core::StringView const& key, T* out) const
    {
        ...
        {
            throw Exception(e.status(), "Failed to map enum name '", str, "' for parameter '", key, "' to numeric value: ", e.messageStr());
        }
    }
    ...
    bool get(dw::core::StringView const& key, size_t const index, dw::core::FixedString<N>* out) const
    {
        ...
        if (success)
        {
            if (N <= str.size())
            {
                throw Exception(DW_BUFFER_FULL, "The FixedString parameter '", key, "' and index ", index, " has a maximum capacity of N=", N, " but the value has a length of ", str.size() + 1, "(including trailing \\0)");
            }
            out->copyFrom(str.data(), str.size());
        }
        return success;
    ...
    bool get(dw::core::StringView const& key, size_t const index, T* out) const
    {
        ...
        {
            throw Exception(e.status(), "Failed to map enum name '", str, "' for parameter '", key, "' and index ", index, " to numeric value: ", e.messageStr());
        }
    }
