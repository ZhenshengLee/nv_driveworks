...
public:
        ...
        , m_functionInt(passFunc)
    {
        ...
        {
            throw Exception(DW_NOT_SUPPORTED, "PassImpl: Only GPU passes can use a cuda stream");
        }
    }
        ...
        , m_functionInt(passFunc)
    {
        ...
        {
            throw Exception(DW_NOT_SUPPORTED, "PassImpl: Only DLA passes can use a DLA handle");
        }
    }
    ...
    void setRunnableId(dw::core::StringView const& runnableId) final
    {
        ...
        {
            throw Exception(DW_BUFFER_FULL, "setRunnableId() runnable id exceeds capacity: ", runnableId);
        }
