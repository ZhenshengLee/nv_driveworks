...
#include <cstring>
#include <mutex>
#include <dw/core/base/ConditionVariable.hpp>
...
public:
    ...
    explicit ElementQueue(size_t const fifoSize = FifoSize)
        ...
        , m_dequeuedSize(0U)
    {
        // TODO(dwplc): FP - Within consumer TUs (e.g., the src/dw/sensors/camera/Camera.cpp constructor) Coverity
        //              claims m_mutex is not initialized in this constructor, even though the mutex's constructor
        //              is called above. Error code: [uninit_member]
        // NOTE: until the TODO is resolved, locking the mutex here fully "initializes" it.
