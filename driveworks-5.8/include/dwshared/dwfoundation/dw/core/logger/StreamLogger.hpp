...
private:
    ...
    static void streamTag(std::ostream& os, FixedString<Logger::TAG_SIZE> const& tag);
    static void streamThreadId(std::ostream& os, FixedString<Logger::TID_SIZE> const& tid);
