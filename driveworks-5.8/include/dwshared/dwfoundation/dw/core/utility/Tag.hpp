...
#ifndef DW_CORE_UTILITY_TAG_HPP_
#define DW_CORE_UTILITY_TAG_HPP_
...
template <typename T>
// TODO(dwplc): FP - this is variable template, not static variable
...
#endif /*DW_CORE_UTILITY_TAG_HPP_*/
