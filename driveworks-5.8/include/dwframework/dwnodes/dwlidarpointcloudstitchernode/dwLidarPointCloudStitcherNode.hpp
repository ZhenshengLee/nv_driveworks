...
#ifndef DW_FRAMEWORK_POINTCLOUD_STITCHERNODE_NODE_HPP_
#define DW_FRAMEWORK_POINTCLOUD_STITCHERNODE_NODE_HPP_
...
public:
    ...
    static constexpr auto describeOutputPorts()
    {
        using namespace dw::framework;
        return describePortCollection(
            DW_DESCRIBE_PORT(dwPointCloud, "POINT_CLOUD"_sv));
    };
...
#endif //DW_FRAMEWORK_LIDAR_POINTCLOUD_ACCUMULATOR_NODE_HPP_
