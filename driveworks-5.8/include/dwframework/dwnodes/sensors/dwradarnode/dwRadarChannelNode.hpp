...
#ifndef DW_FRAMEWORK_RADAR_CHANNEL_NODE_HPP_
#define DW_FRAMEWORK_RADAR_CHANNEL_NODE_HPP_
...
public:
    ...
    dwRadarChannelNode(char8_t const* sensorName, dwConstRigHandle_t rigHandle,
...
#endif // DW_FRAMEWORK_RADAR_CHANNEL_NODE_HPP_
