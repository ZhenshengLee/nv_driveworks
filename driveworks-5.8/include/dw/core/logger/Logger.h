...
typedef enum dwLoggerVerbosity {
    DW_LOG_VERBOSE = 0x0000, //!< Log everything, default log level
    DW_LOG_DEBUG   = 0x1000, //!< Log Debug information
    DW_LOG_INFO    = 0x2000, //!< Log Notice information
    DW_LOG_WARN    = 0x3000, //!< Log Warning information
    DW_LOG_ERROR   = 0x4000, //!< Log Error information
    DW_LOG_SILENT  = 0x7000  //!< Log nothing
} dwLoggerVerbosity;
 ...
 * @retval DW_FAILURE if the logger verbosity is invalid. Provide a valid verbosity level.
 * @retval DW_SUCCESS
 *
 **/
 ...
 *
 * @retval DW_INVALID_ARGUMENT if verbosity is invalid. Provide a valid verbosity level.
 * @retval DW_SUCCESS
 */
 ...
 *
 * @retval DW_FAILURE if verbosity parameter is not inside the dwLoggerVerbosity enum OR if msg is a null pointer.<br>
 ...
 *
 * @retval DW_INVALID_ARGUMENT if verbosity is invalid
 * @retval DW_FAILURE if the function clock_gettime() fails
 * @retval DW_SUCCESS
 */
