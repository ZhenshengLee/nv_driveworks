...
typedef enum dwRadarSensorErrorID {
    /// Default error id as no error
    DW_RADAR_SENSOR_ERROR_ID_INVALID = 0,

    /// Under voltage error
    DW_RADAR_SENSOR_ERROR_ID_UNDER_VOLTAGE = 1,

    /// Over voltage error
    DW_RADAR_SENSOR_ERROR_ID_OVER_VOLTAGE = 2,

    /// Under temperature error
    DW_RADAR_SENSOR_ERROR_ID_UNDER_TEMP = 3,

    /// Over temperature error
    DW_RADAR_SENSOR_ERROR_ID_OVER_TEMP = 4,

    /// Interference error
    DW_RADAR_SENSOR_ERROR_ID_INTERFERENCE = 5,

    /// Full blockage error
    DW_RADAR_SENSOR_ERROR_ID_FULL_BLOCKAGE = 6,

    /// Limited performance error
    DW_RADAR_SENSOR_ERROR_ID_LIMITED_PERF = 7,

    /// No measurement error
    DW_RADAR_SENSOR_ERROR_ID_NO_MEASUREMENT = 8,

    /// Signal not available error
    DW_RADAR_SENSOR_ERROR_ID_SNA = 9,

    /// Time sync error
    DW_RADAR_SENSOR_ERROR_ID_TIMESYNC = 10,
...
*
* @return DW_INVALID_HANDLE, DW_INVALID_ARGUMENT, DW_CALL_NOT_ALLOWED, DW_SUCCESS
*
*/
DW_API_PUBLIC
