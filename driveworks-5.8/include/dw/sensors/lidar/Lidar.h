...
{
    alignas(16) float32_t theta; /*!< Lidar right-handed polar coord system, planar, in rads. */
...
typedef struct dwLidarProperties
{
    ...
    float32_t horizontalFOVStart; /*!< Lidar right-handed polar coord system, planar, in rads, start angle */
    float32_t horizontalFOVEnd;   /*!< Lidar right-handed polar coord system, planar, in rads, end angle */

    uint32_t numberOfRows; /*!< Number of Rows in a spin Frame */

    float32_t verticalFOVStart; /*!< Lidar right-handed polar coord system, vertical, in rads, start angle */
    float32_t verticalFOVEnd;   /*!< Lidar right-handed polar coord system, vertical, in rads, end angle */
...
{
    dwTime_t hostTimestamp;   /*!< Timestamp measured on the host. */
    dwTime_t sensorTimestamp; /*!< Timestamp of the first point in the point cloud packet. */
    dwTime_t duration;        /*!< Time difference between the first measurement and the last. */
    ...
    */
    ...
    dwLidarDecodedReturn returnData[DW_SENSORS_LIDAR_MAX_RETURNS]; /*!< Data for each return in this packet */
 ...
 * @return DW_INVALID_ARGUMENT if auxType does not represents valid aux type
 *         DW_SUCCESS 
 */
DW_API_PUBLIC
...
* The default state is to have decoding on. If on, dwSensor_readRawData returns DW_CALL_NOT_ALLOWED.
*
* @param[in] sensor Specifies the sensor handle of the sensor previously created with 'dwSAL_createSensor()'.
*
* @return DW_INVALID_HANDLE, DW_CALL_NOT_ALLOWED, DW_SUCCESS
*
*/
DW_API_PUBLIC
...
* @param[in] sensor Specifies the sensor handle of the sensor previously created with 'dwSAL_createSensor()'.
*
* @return DW_INVALID_HANDLE, DW_INVALID_ARGUMENT, DW_NOT_AVAILABLE, DW_TIME_OUT, DW_SUCCESS
*
...
* @param[in] rawData A pointer for the non-decoded Lidar packet, returned by 'dwSensor_readRawData()'.
...
* @param[in] sensor Specifies the sensor handle of the sensor previously created with 'dwSAL_createSensor()'.
*
* @return DW_INVALID_HANDLE, DW_INVALID_ARGUMENT, DW_SUCCESS
*
*/
DW_API_PUBLIC
...
* @param[in] sensor Specifies the sensor handle of the sensor previously created with 'dwSAL_createSensor()'.
*
* @return DW_INVALID_HANDLE, DW_INVALID_ARGUMENT, DW_NOT_SUPPORTED, DW_FAILURE, DW_SUCCESS
*
*/
DW_API_PUBLIC
