 ...
 * See the original paper for a description of the model:
...
dwStatus dwCameraModel_initializeOCam(dwCameraModelHandle_t* obj,
 ...
 */
DW_API_PUBLIC
DW_DEPRECATED("dwCameraModel_initializeFTheta is replaced by dwCameraModel_initializeFThetaNew.")
...
dwStatus dwCameraModel_initializeFThetaNew(dwCameraModelHandle_t* obj,
                                           const dwFThetaCameraConfigNew* config,
                                           dwContextHandle_t context);
