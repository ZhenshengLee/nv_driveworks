...
typedef enum dwVehicleIOLateralActuatorInterface {
    DW_VEHICLEIO_LATERAL_ACTUATOR_UNKNOWN     = 0, // lateral control actuator interface is unknown
    DW_VEHICLEIO_LATERAL_STEERING_WHEEL_ANGLE = 1, // uses steering wheel angle for lateral control
    DW_VEHICLEIO_LATERAL_FRONT_WHEEL_ANGLE    = 2, // use front wheel angle for lateral control
    DW_VEHICLEIO_LATERAL_CURVATURE            = 3, // use curvature for lateral control
