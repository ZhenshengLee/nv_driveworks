...
#ifndef DW_IMAGEPROCESSING_FEATURE2D_TRACKER_H_
#define DW_IMAGEPROCESSING_FEATURE2D_TRACKER_H_
...
typedef struct dwFeature2DTrackerConfig
{
    ...
    /** Type of detector that connects to the tracker, should the be the same value as
     ...
     *  level [maxPyramidLevel - numTranslationOnlyLevel - 1, 0] will use scaling track
     *  if numTranslationOnlyLevel = 0, scaling track will be applied to all levels in pyramid
     *
     *  Valid only when algorithm = DW_FEATURE2D_TRACKER_ALGORITHM_EX
     */
...
#endif
/** @} */
#endif // DW_IMAGEPROCESSING_FEATURE2D_TRACKER_H_
