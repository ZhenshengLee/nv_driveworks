...
public:
    ...
    bool onInitialize() override
    {
        ...
        // -----------------------------
        {
            ...
            CHECK_DW_ERROR(dwTemplateArray_create(&templateCPU, maxTemplateCount,
                                                  DW_MEMORY_TYPE_CPU, context));
            CHECK_DW_ERROR(dwTemplateArray_create(&templateGPU, maxTemplateCount,
                                                  DW_MEMORY_TYPE_CUDA, context));
    ...
    void onProcess() override
    {
        ...
        dwImageCUDA planeC;
        CHECK_DW_ERROR(dwImageCUDA_getPlaneAsImage(&planeC, frameCudaRcb, 1));
