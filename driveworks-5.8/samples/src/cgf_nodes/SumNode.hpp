...
#ifndef SUM_NODE_HPP_
#define SUM_NODE_HPP_
...
struct SumNodeParams
{
};

class SumNode : public ExceptionSafeProcessNode
{
public:
    ...
    {
        return describeConstructorArguments<SumNodeParams, dwContextHandle_t>(
    ...
    static std::unique_ptr<SumNode> create(ParameterProvider& provider);

    SumNode(const SumNodeParams& params, const dwContextHandle_t ctx);
};
