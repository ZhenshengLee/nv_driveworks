...
int32_t CreateMatAddProg(double waitDurationTicks, cupvaCmd_t* cmdProg, cupvaExecutable_t const* exec, int32_t* src1_d, int32_t* src2_d,
                         int32_t* dst_d, uint32_t ih, uint32_t iw, uint32_t bh, uint32_t bw);
