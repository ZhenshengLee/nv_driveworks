...
void SSM::initialize()
{
    SSM_LOG("Initializing SM2");
    isStateMachineActive = true;
    initStateMachine();
    ENTER();
}

bool SSM::executeLockedCommand(SystemStateManager::SM2::LockSteppedCommands command)
{
    return executeLockSteppedCommand((int)command);
}

bool SSM::registerLockedCommand(SystemStateManager::SM2::LockSteppedCommands command, SSMFunctionHandler ptr)
{
