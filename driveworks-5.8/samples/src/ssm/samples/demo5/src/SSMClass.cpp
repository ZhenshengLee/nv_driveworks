...
{
    cout << "SSM: Standby:  " << getCurrentState("SM1") << " " << getCurrentState("SM2") << endl;
    Notification n;
...
{
    cout << "SSM: NormalOperation:  " << getCurrentState("SM1") << " " << getCurrentState("SM2") << endl;
...
{
    cout << "SSM: Degrade:  " << getCurrentState("SM1") << " " << getCurrentState("SM2") << endl;
    if (a == 16)
    {
        cout << "===================" << endl;
...
{
    cout << "SSM: UrgentOperation:  " << getCurrentState("SM1") << " " << getCurrentState("SM2") << endl;
