...
std::ostream& operator<<(std::ostream& out, const SM22States state_enum)
{
    return out << SM22_enumToStr(state_enum);
}

const char* SM22_enumToStr(SM22States e)
{
    switch(e)
    {
        case SM22States::A22: return SSM_SM22_A22_str;
        case SM22States::B22: return SSM_SM22_B22_str;
        case SM22States::C22: return SSM_SM22_C22_str;
        case SM22States::D22: return SSM_SM22_D22_str;
    }
    return "NULL_STATE";
}


SM22States SM22_strToEnum(std::string state)
{
    static FixedMap<std::string, SM22States> stringToState
    {
        {SSM_SM22_A22_str, SM22States::A22},
        {SSM_SM22_B22_str, SM22States::B22},
        {SSM_SM22_C22_str, SM22States::C22},
        {SSM_SM22_D22_str, SM22States::D22},
    };
    ...
    return SM22States::NULL_STATE;
}

SM22States get_SM22State(SMBaseClass *obj)
{
    return SM22_strToEnum(obj->getCurrentState(SSM_SM22_str));
}
...
const char* SmEnumToStr(StateMachines e)
{
    switch(e)
    {
        ...
        case StateMachines::SM22: return SSM_SM22_str;
...
StateMachines getSmEnum(std::string sm)
{
    static FixedMap<std::string, StateMachines> sm_string_to_enum_map = 
    {
        ...
        {SSM_SM22_str, StateMachines::SM22},
