...
void SSM::initialize()
{
    SSM_LOG("Initializing SM4");
    isStateMachineActive = true;
    initStateMachine();
    ENTER();
}

bool SSM::executeLockedCommand(SystemStateManager::SM4::LockSteppedCommands command)
{
    return executeLockSteppedCommand((int)command);
}

bool SSM::registerLockedCommand(SystemStateManager::SM4::LockSteppedCommands command, SSMFunctionHandler ptr)
{
