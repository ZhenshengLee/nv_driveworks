...
public:
    ...
    bool onInitialize() override
    {
        ...
        // -----------------------------------------
        {
            ...
            CHECK_DW_ERROR_MSG(
                dwRadarDopplerMotion_initialize(&m_radarMotion, cudaStream_t(nullptr), m_context),
    ...
    bool processSensorEvent()
    {
        ...
        case DW_SENSOR_CAMERA:
        {
            ...
            if (getWindow())
            {
                dwImageHandle_t frameGL = m_streamerCUDA2GL->post(nextFrameCUDA);
    ...
    void handleRadarScan()
    {
        ...
        CHECK_DW_ERROR_MSG(dwRadarDopplerMotion_processAsync(&myscan, m_radarMotion),
                           "dwRadarDopplerMotion: process radar scan error!");
    ...
    void onRender() override
    {
        ...
        CHECK_DW_ERROR_MSG(dwRenderer_renderText(10, 220, ss.str().c_str(), m_renderer),
