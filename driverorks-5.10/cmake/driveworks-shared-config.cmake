...
foreach(LIB ${LIBS})
    ...
    target_include_directories(${NAME} INTERFACE "${${LIB}_INCLUDE_DIR}/dwshared")
    target_include_directories(${NAME} INTERFACE "${${LIB}_INCLUDE_DIR}/dwshared/dwcbor")
    target_include_directories(${NAME} INTERFACE "${${LIB}_INCLUDE_DIR}/dwshared/dwfoundation")
    target_include_directories(${NAME} INTERFACE "${${LIB}_INCLUDE_DIR}/dwshared/dwsocket")
    target_include_directories(${NAME} INTERFACE "${${LIB}_INCLUDE_DIR}/dwshared/dwtrace")
    ...
    add_library(driveworks-shared::${LIB}-lib SHARED IMPORTED)

    set_target_properties(driveworks-shared::${LIB}-lib PROPERTIES
      IMPORTED_LOCATION "${${LIB}_LIBRARY}"
    )

    target_link_libraries(${NAME} INTERFACE driveworks-shared::${LIB}-lib)
