...
*
* @return DW_INVALID_ARGUMENT <ul><li>if given context handle or fileFunctionPtr is NULL.</li></ul>
          DW_INVALID_HANDLE   if given context handle is not an actual handle. Provide a valid context handle.<br>
 ...
 * @param[in] headerVersion Specifies current driveworks API version
 *            (usually DW_VERSION).
 * @param[in] params A pointer with a set of parameters to create the SDK.
 *            Can be NULL for a default set of parameters.
 *
 * @return DW_INVALID_VERSION <ul><li>if the DW version does not match the version of the library.</li></ul>
 ...
 *
 * @return <ul><li>DW_INVALID_HANDLE if provided context is NULL or invalid.</li></ul>
 *         DW_SUCCESS if no error occurs.
 *
 */
DW_API_PUBLIC
 ...
 *
 * @return DW_INVALID_ARGUMENT <ul><li>if given context handle or time is NULL.</li></ul>
 ...
 * @param[in] context Specifies the context.
 *
 * @return DW_INVALID_ARGUMENT if given context handle or source is. NULL. Provide valid input parameters.<br>
 *         DW_INVALID_HANDLE if given context handle is not valid. Provide a valid context pointer.<br>
 *         DW_SUCCESS
 *
 ...
 *       There is no current mechanism to determine whether the PTP framework lost its sync during runtime.
 **/
DW_API_PUBLIC
 ...
 * @return DW_INVALID_ARGUMENT <ul><li>if the given context is NULL.</li></ul>
 *         DW_INVALID_HANDLE if given context handle is not valid.<br>
 ...
 *
 * @return DW_INVALID_ARGUMENT <ul><li>if context handle is NULL or the selected device doesn't exist or
 *                             if the input device number does not match to the number of available devices.</li></ul>
 *         DW_INVALID_HANDLE if given context handle is not valid.<br>
 ...
 * @param[in] context Specifies the context handle.
 *
 * @return DW_INVALID_ARGUMENT <ul><li>if context handle is NULL.</li></ul>
 *         DW_INVALID_HANDLE if given context handle is not valid.<br>
 *         DW_SUCCESS if no error occurs.
 */
DW_API_PUBLIC
 ...
 * @param[in] context Specifies the context handle.
 *
 * @return DW_INVALID_ARGUMENT <ul><li>if value pointer or context handle is NULL or deviceNum doesn't exist or
 *                             if the input device number does not match to the number of available devices.</li></ul>
 *         DW_INVALID_HANDLE if given context handle is not valid.<br>
 *         DW_CUDA_ERROR in case of an underlying CUDA failure.<br>
 *         DW_NOT_AVAILABLE if no GPU devices are available.<br>
 ...
 */
DW_API_PUBLIC
dwStatus dwContext_getGPUProperties(cudaDeviceProp* const properties, int32_t const deviceNum,
 ...
 * @param[in] context Specifies the context handle.
 *
 * @return DW_INVALID_ARGUMENT <ul><li>if value pointer or context handle is NULL or context is NULL or
 *                             if the input device number does not match to the number of available devices or
 *                             if the selected device doesn't exist. </li></ul>
 *         DW_INVALID_HANDLE if given context handle is not valid. <br>
 *         DW_CUDA_ERROR in case of an underlying CUDA failure <br>
 *         DW_NOT_AVAILABLE if no GPU devices are available <br>
 *         DW_SUCCESS if no error occurs.
 ...
 * @param[in] context Specifies the context handle.
 *
 * @return DW_INVALID_ARGUMENT <ul><li>if value pointer or context handle is NULL.</li></ul>
 *         DW_INVALID_HANDLE if given context handle is not valid. <br>
 *         DW_SUCCESS if no error occurs.
 */
DW_API_PUBLIC
 ...
 * @param[in] context Specifies the context handle.
 *
 * @return DW_INVALID_ARGUMENT <ul><li>if context handle, driverVersion or apiVersion are NULL.</li></ul>
 *         DW_INVALID_HANDLE if given context handle is not valid.<br>
 *         DW_CUDA_ERROR in case of an underlying CUDA failure.<br>
 *         DW_SUCCESS if no error occurs.
 */
 ...
 * @param[in] context Specifies the context handle.
 *
 * @return DW_INVALID_ARGUMENT <ul><li>if context handle is NULL or number is invalid or
 *                             if the input device number does not match to the number of available devices.</li></ul>
 *         DW_INVALID_HANDLE if given context handle is not valid. <br>
 *         DW_SUCCESS if no error occurs.
 */
 ...
 *         DW_INVALID_HANDLE if given context handle is not valid. <br>
 *         DW_NOT_AVAILABLE if a display address initialization fails
 *         DW_CANNOT_CREATE_OBJECT if a display initialization fails
 *         DW_SUCCESS if no error occurs.
 *
 ...
 * @param[in] context Specifies the context handle.
 *
 * @return DW_INVALID_ARGUMENT <ul><li>if context handle or descriptor pointer is NULL.</li></ul>
 *         DW_INVALID_HANDLE if given context handle is not valid. <br>
 *         DW_SUCCESS if no error occurs.
 */
DW_API_PUBLIC
