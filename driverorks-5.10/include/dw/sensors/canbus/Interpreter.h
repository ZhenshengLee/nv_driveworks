...
/**
* Same as dwCANInterpreter_encodef32, but for float64 types. @see dwCANInterpreter_encodef32
*/
DW_API_PUBLIC
...
/**
* Same as dwCANInterpreter_encodef32, but for int32 types. @see dwCANInterpreter_encodef32
*/
DW_API_PUBLIC
...
/**
* Same as dwCANInterpreter_getf32, but for float64 types. @see dwCANInterpreter_getf32
*/
DW_API_PUBLIC
dwStatus dwCANInterpreter_getf64(float64_t* value, dwTime_t* timestamp_us, uint32_t idx, dwCANInterpreterHandle_t interpreter);

/**
* Same as dwCANInterpreter_getf32, but for int32 types. @see dwCANInterpreter_getf32
*/
DW_API_PUBLIC
