...
/**
 * Releases the SAL (sensor abstraction layer) module. This method releases all created sensors and unloads all drivers.
 *
...
/**
 * Gets the parameter string acceptable by a sensor whose type is determined by the index. A sensor generates a human
 * readable string with parameters it accepts. It might contain optional parameters
 * indicated with []. All parameters are represented as key=value pairs, separated by a comma.
 *
