...
// This is an autogenerated file from VehicleIOValStructures.json.
// The autogeneration script is checked in at src/dw/control/vehicleio/VIOGen.py
...
typedef struct dwVehicleIONonSafetyState
{
    ...
    /// @note TODO: Backend not yet implemented
    /// @note min nan    max nan
    /// @note freq nan    unit unitless, OFF = false, ON = true
    /// @note bool type (please use bool relevant functions)
    /// @note *** valid values**: {0, 1}
    ...
    /// @note ID VS-17210
    /// @note description This signal shows if driving or parking function was activated.
    /// @note TODO: Backend not yet implemented
    /// @note min nan    max nan
    /// @note freq 100    unit unitless bitfield
...
typedef struct dwVehicleIONonSafetyCommand
{
    ...
    /// @note TODO: Backend not yet implemented
    /// @note min NOT_ACCEPTED    max INVALID
    /// @note freq nan    unit  -
    /// @note *** valid values**: {
