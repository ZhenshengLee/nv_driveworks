...
public:
    ...
    bool changeState(SM22States e);
    int sendDataByID(StateMachines e, void *data, int datalen, std::string dataStructID);
    SM22States getState();

    StateMachines stateMachineId {StateMachines::SM22};
    // API to register LockedStepCommands
    bool registerLockedCommand(SystemStateManager::SM4::LockSteppedCommands command, SSMFunctionHandler ptr);
