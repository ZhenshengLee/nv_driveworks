...
void SSM::initialize()
{
    SSM_LOG("Initializing SM3");
    isStateMachineActive = true;
    initStateMachine();
    ENTER();
}

bool SSM::executeLockedCommand(SystemStateManager::SM3::LockSteppedCommands command)
{
    return executeLockSteppedCommand((int)command);
}

bool SSM::registerLockedCommand(SystemStateManager::SM3::LockSteppedCommands command, SSMFunctionHandler ptr)
{
