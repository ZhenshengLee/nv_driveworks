...
struct Proxy
{
    ...
    Proxy()
    {
        m_sigShem   = {CustomRawBufferTypeID, dw::framework::DW_CHANNEL_TYPE_SHMEM_LOCAL};
        m_sigSocket = {CustomRawBufferTypeID, dw::framework::DW_CHANNEL_TYPE_SOCKET};
        m_sigNvSci  = {CustomRawBufferTypeID, dw::framework::DW_CHANNEL_TYPE_NVSCI};
