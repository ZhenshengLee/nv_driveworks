...
void printProperties(cudaDeviceProp* props)
{
    ...
    std::cout << "CUDA Capability Major/Minor version number: " << props->major << "." << props->minor
              ...
              << std::endl
              << "Memory Clock rate Khz: " << props->memoryClockRate
              << std::endl
              ...
              << std::endl
              << "Maximum Layered 1D Texture Size, (x): " << props->maxTexture1DLayered[0] << " num: " << props->maxTexture1DLayered[1]
              << std::endl
              << "Maximum Layered 2D Texture Size, (x,y): " << props->maxTexture2DLayered[0] << ", " << props->maxTexture2DLayered[0] << " num: " << props->maxTexture2DLayered[2]
              << std::endl
