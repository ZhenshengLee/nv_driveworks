...
public:
    ...
    bool onInitialize() override
    {
        ...
        cupvaStreamCreate(&m_cupvaStream,
                          cupvaEngineType_t::CUPVA_PVA0, cupvaAffinityType_t::CUPVA_VPU_ANY);
#endif
#endif
        ...
        // -----------------------------
        {
            ...
            CHECK_DW_ERROR(dwFeature2DDetector_initialize(&detector, &detectorConfig,
#if VIBRANTE_PDK_DECIMAL >= 6000400
                                                          m_cudaStream
#else
                                                          0
            ...
            if (cupvaCudaCreateStream(&m_cupvaStream, m_cudaStream, pvaEngineType::PVA_PVA0, pvaAffinityType::PVA_VPU0) != pvaError::PVA_ERROR_NONE)
            {
                throw std::runtime_error("Failed to create cupva stream from cuda stream for detector");
            }
#endif
            if (pvaDetector)
            {
            ...
            CHECK_DW_ERROR(dwFeature2DTracker_initialize(&tracker, &trackerConfig,
#if VIBRANTE_PDK_DECIMAL >= 6000400
                                                         m_cudaStream
#else
                                                         0
