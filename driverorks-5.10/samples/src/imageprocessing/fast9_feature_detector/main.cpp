...
public:
    ...
    bool onInitialize() override
    {
        ...
        // -----------------------------
        {
            CHECK_DW_ERROR(dwFeatureArray_create(&featuresDetectedCPU, maxFeatureCount,
                                                 DW_MEMORY_TYPE_CPU, m_context));
            CHECK_DW_ERROR(dwFeatureArray_create(&featuresDetectedGPU, maxFeatureCount,
